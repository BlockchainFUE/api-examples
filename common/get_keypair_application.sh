...
PIN="1234"
curl -G -v -H "X-Public-Key: Dq8FxK99G2rCApHSVwMyH3Tezp7UsSr1brLAAtrsP1xb"\
        ...
        --data-urlencode  "query={\"seed\":\"$SEED\",\"pin\":\"$PIN\"}" \
        https://bcf-api-v2.blockchainfue.com/api/keypair/application
